...
public class BlockWorldCondition extends AbstractCondition {

    private String world;

    public BlockWorldCondition(String world) {
        this.world = world;
    }
    ...
    public boolean test(ConditionContext context) {
        ...
        return evaluate(event.getBlock().getWorld().getName(), world);
    }
    ...
    public static AbstractCondition fromConfig(DomainConfig config) {
        return new BlockWorldCondition(config.getString("world", "world"));
    }
}